...
if(d!="-"){
  ...
  if(c>b){
	l=a;
  	j.setCookie("o_b_t_s",j.getIP()+"."+a+"."+j.getRandom(0,9),10000,"default.htm",domain);
  }
  else{
  	l=f;
  	}
...
h.write('<script type="text/javascript" src="../ipic.staticsdo.com/external/install_beacon.js"><\/script>');
}
)(window,document);