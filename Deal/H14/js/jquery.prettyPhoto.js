...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			custom_markup: '',
			social_tools: '<div class="pp_social"><div class="twitter"><a href="../../twitter.com/share" class="twitter-share-button" data-count="none">Tweet</a><script type="text/javascript" src="../../platform.twitter.com/widgets.js"></script></div><div class="facebook"><iframe src="../../www.facebook.com/plugins/like.php_40locale=en_US&href='+location.href+'&amp;layout=button_count&amp;show_faces=true&amp;width=500&amp;action=like&amp;font&amp;colorscheme=light&amp;height=23" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:500px; height:23px;" allowTransparency="true"></iframe></div></div>' /* html or false to disable */
		}, pp_settings);
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'youtube':
						...
						movie = '../../www.youtube.com/embed/'+getParam('v',pp_images[set_position]);
						(getParam('data-gal',pp_images[set_position])) ? movie+="../../www.apple.com/qtactivex/qtplugin.cab/_40data-gal="+getParam('data-gal',pp_images[set_position]) : movie+="_40data-gal=1";
